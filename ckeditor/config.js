	...
	CKEDITOR.editorConfig = function (config) {
        ...
        ***/
		...
		(config.filebrowserBrowseUrl =
			"https://bahanu.com/ckeditor/ckfinder/ckfinder.php"),
			(config.filebrowserUploadUrl =
				"https://bahanu.com/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
			(config.filebrowserImageUploadUrl =
				"https://bahanu.com/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
			(config.filebrowserFlashUploadUrl =
				"https://bahanu.com/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
			// My Plugin
			/*/		
            config.plugins =
            // Plugin
