						...
						swal(
							{
								title: "Gửi lại mail xác thực",
								type: "success",
								text: "Bahanu Shop đã gửi mã xác thực mới đến email đăng ký của bạn. Vui lòng kiểm tra email để có mã xác thực !",
							},
							function () {}
						);
					}
					...
					swal(
						{
							...
							type: "success",
							text: "Kích hoạt tài khoản thành công. Chúc bạn có nhiều trải nghiệm với Bahanu!",
						},
						function () {
							var url = "/";
