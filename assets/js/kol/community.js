...
// show list friends - author : Khanh - date : 03/04/2023
function openList() {
	var sidenav = document.getElementById("right_page"),
		main = document.getElementById("btn");
	sidenav.style.width = sidenav.style.width == "350px" ? "0" : "350px";
	main.style.marginRight = main.style.marginRight === "350px" ? "0" : "350px";
}
