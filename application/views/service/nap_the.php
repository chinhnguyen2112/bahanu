            ...
            <div class="left_cash">
                ...
                <div class="form_left_cash card">
                    ...
                    <div class="box_type_cash">
                        <img class="img_type_card" onclick="val_type(this,'VINAPHONE')" src="/images/cash/vina.png" alt="vina phone">
                        <img class="img_type_card" onclick="val_type(this,'VIETTEL')" src="/images/cash/viettel.png" alt="viettel">
                        <!-- <img src="/images/cash/gmobile.png" alt="g mobile"> -->
                        <img class="img_type_card" onclick="val_type(this,'MOBIFONE')" src="/images/cash/mobi.png" alt="mobile phone">
                        <!-- <img src="/images/cash/vienam.png" alt="vietnammobile"> -->
                    </div>
                ...
                <div class="form_left_cash momo">
                    <div class="img_momo">
                        <img src="/images/cash/mono.png" alt="momo">
                    </div>
                    <div class="text_momo">
                        <p class="nd_ck">Ví điện tử MOMO</p>
                        <p class="data_mono pd_25"><img src="/images/cash/icon_crow.svg" alt="chỉ mục">Số điện thoại: 0976615309</p>
                        <p class="data_mono pd_25"><img src="/images/cash/icon_crow.svg" alt="chỉ mục">Tên tài khoản: Chu Thị Ngọc Anh</p>
                ...
                <div class="form_left_cash atm">
                    <div class="img_atm">
                        <img src="/images/cash/atm.png" alt="atm">
                    </div>
                    <div class="text_momo">
                        <p class="nd_ck">Ngân hàng: Techcombank</p>
                        <p class="data_mono pd_25"><img src="/images/cash/icon_crow.svg" alt="chỉ mục">Số tài khoản: 1902 9151 126 668</p>
                        <p class="data_mono pd_25"><img src="/images/cash/icon_crow.svg" alt="chỉ mục">Tên tài khoản: Chu Thị Ngọc Anh</p>
                        <p class="nd_ck ">Nội dung chuyển khoản: Số điện thoại - ID tài khoản</p>
                        <p class="nd_ck ">Ví dụ: 0358888888 - #1815</p>
                    </div>
                ...
                <div class="form_left_cash bot_atm_momo">
                    <div class="text_atm_momo">
                        <p class="text_title_bot_atm_momo"><img src="/images/cash/icon_crow.svg" alt="chỉ mục"><span>Hệ thống nạp<span class="span_bot_atm_momo">&nbspATM/MOMO tự động 24/24</span>, Nạp 100.000đ nhận 125.000đ tiền Shop.</span></p>

                        <p class="text_title_bot_atm_momo"><img src="/images/cash/icon_crow.svg" alt="chỉ mục"><span><span class="span_bot_atm_momo">Lưu ý:</span> Chuyển tiền nhanh 24/7 để tránh bị treo, chậm tiền!<br> Nếu gửi đúng stk và nội dung mà 30 phút không nhận được tiền hoặc chuyển ghi sai nội dung vui lòng liên hệ page để được hỗ trợ. </span></p>
                        <div class="box_example_cash">
                            ...
                            <div class="box_ex_cash">
                                ...
                                <img class="img_repaet_cash" src="/images/cash/repeat.svg" alt="chuyển đổi">
                                <div class="box_nav_cash">
            ...
            <div class="form_right_cash">
                <div class="detail_acc_cash">
                    ...
                    <div class="data_user_cash">
                        <img src="/<?php if ($_SESSION['user']['avatar'] != '') {
                    ...
                    <div class="so_du">
                        <p class="p_so_du">Số dư tài khoản <span class="span_so_du">[ZEN]</span></p>
                        <p class="p_mun_du"><?= number_format($_SESSION['user']['zen']) ?> Zen</p>
                    </div>
                </div>
                <div class="noti_cash">
