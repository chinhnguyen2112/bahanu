        ...
        <div class="detail_acc_right">
            <div class="right_uudai">
                <div class="div_uudai">
                    <div class="box_title_uudai">
                        <img class="img_icon_uudai" src="/images/detail/gift.png" alt="ưu đãi">
            ...
            <div class="right_detail_ul">
                ...
                <div class="right_detail_li right_detail_li_type">
                    <img src="/images/detail/atm_banking.png" alt="atm">
                    <img src="/images/detail/visa.png" alt="visa">
                    <img src="/images/detail/paypal.png" alt="paypal">
                    <img src="/images/detail/momo.png" alt="momo">
                </div>
            </div>
        </div>
    </div>
...
<script>
    var id_user = '<?= (check_login()) ? $_SESSION['user']['id'] : '' ?>';
</script>