...
<form id="form" class="form_change_pass">
    ...
    <div class="form-group">
        ...
        <input disabled type="text" class="form-control" id="usrename" name="usrename" placeholder="usrename" value="<?= ($id > 0) ? $account['username'] : '' ?>">
    </div>
    <div class="form-group">
        <label>Tên</label>
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="admin" id="">
            <option <?= ($id > 0 &&  $account['user_type'] == 0) ? 'selected' : '' ?> value="0">user</option>
            <option <?= ($id > 0 &&  $account['user_type'] == 2) ? 'selected' : '' ?> value="3">KOL</option>
        </select>
    </div>
    <div class="form-group">
